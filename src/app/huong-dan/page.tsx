        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            ...
            <a href="mailto:support@taycamhanoi.vn" className="border border-gray-200 rounded-xl p-4 text-center hover:border-blue-400 transition">
              ✉️ <p className="font-semibold mt-1">Email</p>
              <p className="text-gray-500 text-xs">support@taycamhanoi.vn</p>
            </a>
            <Link href="/chinh-sach/chinh-sach-bao-hanh" className="border border-gray-200 rounded-xl p-4 text-center hover:border-blue-400 transition">
              🛡️ <p className="font-semibold mt-1">Chính sách bảo hành</p>
            </Link>
          </div>
        </div>
      </section>
